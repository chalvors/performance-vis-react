...
import { GradeData, GradeVariable } from "../mock_data/data";
...
type ParallelCoordinateProps = {
    ...
    height: number;
    data: GradeData;
    variables: GradeVariable[];
};

type YScale = d3.ScaleLinear<number, number, never>;

export const ParallelCoordinateFilled = ({
    width,
    height,
    data,
    variables,
    ...
    const allLines = data.map((series, i) => {
        ...
        return <path key={i} d={d} stroke={"#000000"} fill="none" />;
    });
